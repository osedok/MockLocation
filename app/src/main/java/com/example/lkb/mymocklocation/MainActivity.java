...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick_mock(View view) {
        String mockLat = mEtLat.getText().toString();
        String mockLng = mEtLng.getText().toString();
        if (mockLat.isEmpty()){
            mockLat=mEtLat.getHint().toString();
        }
        if (mockLng.isEmpty()){
            mockLng=mEtLng.getHint().toString();
        }
        Intent mockLocServiceIntent = new Intent(MainActivity.this, MockGpsService.class);
        mockLocServiceIntent.putExtra("mockLat",mockLat);
        mockLocServiceIntent.putExtra("mockLng",mockLng);
