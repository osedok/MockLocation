...
//                        sendBroadcast(intent);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mockLat = Double.parseDouble(intent.getStringExtra("mockLat"));
        mockLng = Double.parseDouble(intent.getStringExtra("mockLng"));
...
//        DisplayToast("Mock Loction Service finish");
    ...
    public Location generateLocation(double lat, double lng) {
        Location loc = new Location("gps"); //(LocationManager.GPS_PROVIDER);
...
//        Log.d("WATCH",loc.toString());
    ...
    private void setNetworkLocation() {
        ...
        try {
            ...
            //for test
            //locationManager.setTestProviderLocation(LocationManager.GPS_PROVIDER, generateLocation(mockLat, mockLng));
        } catch (Exception e) {
            Log.d(TAG, "setNetworkLocation error");
            e.printStackTrace();
        }
